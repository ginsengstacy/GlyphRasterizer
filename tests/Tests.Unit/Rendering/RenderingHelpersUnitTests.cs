...
public class RenderingHelpersUnitTests
{
    ...
    public void DrawGlyphVisual_Should_ReturnDrawingVisual()
    {
        ...
        DrawingVisual drawingVisual = RenderingHelpers.DrawGlyphVisual(geometry, scale, color);
