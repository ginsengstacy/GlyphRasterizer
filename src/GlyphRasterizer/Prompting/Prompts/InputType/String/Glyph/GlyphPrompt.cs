...
public sealed class GlyphPrompt(GlyphParser glyphParser, PromptActionParser promptActionParser)
    : PromptBase<GlyphParseContext, ImmutableArray<Glyph>?>(promptActionParser)
{
    ...
    protected override IPromptInputParser<GlyphParseContext, ImmutableArray<Glyph>?> Parser { get; } = glyphParser;
